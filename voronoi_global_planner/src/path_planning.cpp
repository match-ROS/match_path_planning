                               ...
                               bool use_eight_neighbors)
{
    ...
    while (!found_goal && !resign)
    {
        ...
        if (voronoi_map.at<uchar>(curr_cell_x, curr_cell_y) == VORONOI_VALUE)
        {
            ...
            return planning_status::Success;
        }
    ...
    return planning_status::DirectConnectionToGoal;
}
...
{
    int connect_goal_success = planning_status::Failed;
    int connect_start_success = planning_status::Failed;
    ...
    else
    {
        ...
        connect_goal_success = planning_status::Success;
    }
    ...
    else
    {
        ...
        connect_start_success = planning_status::Success;
    }

    if (connect_start_success == planning_status::DirectConnectionToGoal || connect_goal_success == planning_status::DirectConnectionToGoal)
    {
    ...
    if (!(connect_start_success == planning_status::Success && connect_goal_success == planning_status::Success))
    {
